...
public class FrozenApocalypseConfig {
    ...
    private void addDefaultApocalypseLevels() {
        this.apocalypseLevels.addAll(List.of(
                ...
                new ApocalypseLevel.Builder(3, 3, 5, 0.7f).freezeEntities(84, 2, 0, 0.0f).grassToFrostedGrass().mobsCanSurviveDaylight().allBiomesSnow().waterToIce().placeSnow().leavesToDeadLeaves().build(),
                new ApocalypseLevel.Builder(4, 4, 7, 0.6f).freezeEntities(62, 3, 0, 0.0f).grassToFrostedGrass().mobsCanSurviveDaylight().allBiomesSnow().waterToIce().placeSnow().leavesToDeadLeaves().build(),
                new ApocalypseLevel.Builder(5, 5, 9, 0.5f).freezeEntities(45, 4, 32, 0.5f).grassToFrostedGrass().mobsCanSurviveDaylight().allBiomesSnow().waterToIce().placeSnow().leavesToDeadLeaves().frostedGrassToDeadGrass().iceToPackedIce().lavaToObsidian().build(),
                new ApocalypseLevel.Builder(6, 6, 11, 0.4f).freezeEntities(30, 5, 32, 1.0f).grassToFrostedGrass().mobsCanSurviveDaylight().allBiomesSnow().waterToIce().placeSnow().leavesToDeadLeaves().frostedGrassToDeadGrass().iceToPackedIce().lavaToObsidian().placeSnowBlock().mobsCanSpawnDaylight().build(),
                new ApocalypseLevel.Builder(7, 7, 13, 0.3f).freezeEntities(20, 6, 16, 1.5f).grassToFrostedGrass().mobsCanSurviveDaylight().allBiomesSnow().waterToIce().placeSnow().leavesToDeadLeaves().frostedGrassToDeadGrass().iceToPackedIce().lavaToObsidian().placeSnowBlock().mobsCanSpawnDaylight().build(),
                new ApocalypseLevel.Builder(8, 8, 15, 0.2f).freezeEntities(20, 7, 16, 2.0f).grassToFrostedGrass().mobsCanSurviveDaylight().allBiomesSnow().waterToIce().placeSnow().leavesToDeadLeaves().frostedGrassToDeadGrass().iceToPackedIce().lavaToObsidian().placeSnowBlock().mobsCanSpawnDaylight().deadGrassToPermafrost().leavesDecay().build(),
                new ApocalypseLevel.Builder(9, 9, 17, 0.1f).freezeEntities(20, 8, 16, 2.5f).grassToFrostedGrass().mobsCanSurviveDaylight().allBiomesSnow().waterToIce().placeSnow().leavesToDeadLeaves().frostedGrassToDeadGrass().iceToPackedIce().lavaToObsidian().placeSnowBlock().mobsCanSpawnDaylight().deadGrassToPermafrost().leavesDecay().build()
        ));
    }
